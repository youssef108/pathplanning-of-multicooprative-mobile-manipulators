...
class Whale_MAPath:
	def __init__(self,Robot_list,length,populationsize,obstacles,b):
...
if __name__ == '__main__':
	...
	#####################	PATH PLANNING WOA ALGORITHM ####################

	WOA_Path_Planning = Whale_MAPath(best_taskAllocation.Robot_list,2,600,obstacle_list,-0.5)	

	WOA_Path_Planning.assign_total_path_to_population()	
	print ("ALL paths are assigned using assign_total_path")
	WOA_Path_Planning.assign_cost_to_population()
	print("before iterations finished assign costs !")
	WOA_Path_Planning.sort_the_population()
	print("before iterations finished sorting !")
	WOA_Path_Planning.display_sorted_costs()
	Best_MA_PATH=WOA_Path_Planning.get_best_MA_WOA()
	...
	WOA_Path_Planning.get_best_MA_WOA().draw(ax1)		
	...
	while(i<i_max):
		...
		WOA_Path_Planning.a = 2 - 2*(i/i_max)
		print("self .a =",WOA_Path_Planning.a)
		WOA_Path_Planning.old_population=copy.deepcopy(WOA_Path_Planning.population)
		print("copied the pop")
		WOA_Path_Planning.modify()
		...
		WOA_Path_Planning.display_sorted_costs()
		#Best_MA_PATH=WOA_Path_Planning.get_best_MA_WOA()
		current_best_cost_pp = WOA_Path_Planning.population[0].cost_mapath
